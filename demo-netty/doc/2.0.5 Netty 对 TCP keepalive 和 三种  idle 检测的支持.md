# Netty 对 TCP keepalive 和 三种  idle 检测的支持

## 1、keepalive 与 idle 监控
...
### 1.2、怎么设计 keepalive？以 TCP keepalive 为例
...
### 1.5、如何在 Netty 中开启 TCP keepalive 和 Idle 监测
...
## 2、源码解读 Netty 对 TCP keepalive 和三种 idle 检测的支持
